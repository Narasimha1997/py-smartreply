...
TfLiteRegistration* tflite::ops::custom::registry::Register_PREDICT() {
  static TfLiteRegistration r = {
    tflite::ops::custom::predict::Init,
    tflite::ops::custom::predict::Free, 
    tflite::ops::custom::predict::Prepare,
    tflite::ops::custom::predict::Eval
  };
  return &r;
}