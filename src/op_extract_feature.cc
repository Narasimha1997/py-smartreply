...
TfLiteRegistration * tflite::ops::custom::registry::Register_EXTRACT_FEATURES() {
  static TfLiteRegistration r = {nullptr, nullptr, tflite::ops::custom::extract::Prepare,
                                 tflite::ops::custom::extract::Eval};
  return &r;
}
