...
void RegisterSelectedOps(tflite::ops::builtin::BuiltinOpResolver* resolver) {
  resolver->AddCustom("Normalize", tflite::ops::custom::registry::Register_NORMALIZE());
  resolver->AddCustom("Predict", tflite::ops::custom::registry::Register_PREDICT());
  resolver->AddCustom("ExtractFeatures", tflite::ops::custom::registry::Register_EXTRACT_FEATURES());
}
